<template>
  <div class="tinymce-box">
    <Editor v-model="htmlContent" :init="init" />
  </div>
</template>
...
export default class TEditor extends Vue {
  private htmlContent: string = "";
  
  //设定富文本上传事件对外开放
  public upload_handler:
    | ((blobInfo: any, success: any, failure: any) => void)
    | undefined;
  private get plugins() {
    return {
      type: [String, Array],
  ...
  private get init() {
    return {
      ...
      images_upload_handler: (blobInfo: any, success: any, failure: any) => {
        if (this.upload_handler != undefined) {
  ...
  //设置富文本HTML内容
  public SetHtmlContent(qHtmlContent: string) {
    this.htmlContent = qHtmlContent;
  }
}
</script>